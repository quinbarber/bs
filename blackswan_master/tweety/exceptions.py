...
class UserNotFound(Exception):
    ...
    def __init__(
        self, error_code, error_name, response, message="The User Account wasn't Found"
    ):
...
class GuestTokenNotFound(Exception):
    """
    Exception Raised when the guest token wasn't found after specific number of retries
    ...
    def __init__(
        ...
        error_name,
        response,
        message="The Guest Token couldn't be obtained",
    ):
        self.message = message
        self.error_code = error_code
        self.error_name = error_name
...
class InvalidTweetIdentifier(Exception):
    ...
    def __init__(
        ...
        error_name,
        response,
        message="The Tweet Identifier is Invalid",
    ):
        self.message = message
        self.error_code = error_code
        self.error_name = error_name
...
class ProxyParseError(Exception):
    ...
    def __init__(
        self,
        message="Error while parsing the Proxy, please make sure you are passing the right formatted proxy",
    ):
        self.message = message
        super().__init__(self.message)
...
class UserProtected(Exception):
    ...
    def __init__(
        ...
        error_name,
        response,
        message="The User is Protected , please make sure you are authenticated and authorized",
    ):
        self.message = message
        self.error_code = error_code
        self.error_name = error_name
...
class InvalidCredentials(Exception):
    ...
    def __init__(
        self, error_code, error_name, response, message="The Cookies are Invalid"
    ):
        self.message = message
        self.error_code = error_code
        self.error_name = error_name
...
class AuthenticationRequired(Exception):
    ...
    def __init__(
        ...
        error_name,
        response,
        message="You need to be authenticated to make this request",
    ):
        self.message = message
        self.error_code = error_code
        self.error_name = error_name
